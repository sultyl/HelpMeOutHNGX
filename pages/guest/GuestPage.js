...
export default function GuestPage() {
    ...
    React.useEffect(() => {
        ...
        document.addEventListener('videoRecorded', handleVideoRecorded);

        return () => {
            // Remove the event listener when the component unmounts
            document.removeEventListener('videoRecorded', handleVideoRecorded);
        };
    }, []);
                    ...
                    <div className='w-full'>
                        ...
                        <div className='flex flex-col gap-16 items-start'>
                            <div className="flex flex-col items-start gap-2">
                                <h6 className='text-[#727272] text-base'>Name</h6>
                                <div className='flex gap-6 justify-center items-center'>
                                    <h2 className='text-[#413C6D] text-2xl font-semibold'>Video Title</h2>
